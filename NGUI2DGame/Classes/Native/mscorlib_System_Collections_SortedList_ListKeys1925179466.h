...
struct  ListKeys_t1925179466  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_host_0() { return static_cast<int32_t>(offsetof(ListKeys_t1925179466, ___host_0)); }

...
struct  ClickNotification_t3184017079 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ClickNotification_t3184017079, ___value___1)); }

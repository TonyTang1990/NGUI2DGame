...
struct  ReferencedTable_t2363768325 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ReferencedTable_t2363768325, ___value___1)); }

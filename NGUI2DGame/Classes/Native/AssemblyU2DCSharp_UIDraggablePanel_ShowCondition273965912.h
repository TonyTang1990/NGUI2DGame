...
struct  ShowCondition_t273965912 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ShowCondition_t273965912, ___value___1)); }

...
struct ThreadSafeDictionaryValueFactory_2_t705;
...
struct  ThreadSafeDictionary_2_t706  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t705 * ____valueFactory_1;
	...
	Dictionary_2_t3804 * ____dictionary_2;
};

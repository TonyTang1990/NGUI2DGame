...
struct HumanLimit_t250797648_marshaled_pinvoke
{
	Vector3_t2243707580_marshaled_pinvoke ___m_Min_0;
	Vector3_t2243707580_marshaled_pinvoke ___m_Max_1;
	Vector3_t2243707580_marshaled_pinvoke ___m_Center_2;
	float ___m_AxisLength_3;
	int32_t ___m_UseDefaultValues_4;
};
// Native definition for marshalling of: UnityEngine.HumanLimit
struct HumanLimit_t250797648_marshaled_com
{
	Vector3_t2243707580_marshaled_com ___m_Min_0;
	Vector3_t2243707580_marshaled_com ___m_Max_1;
	Vector3_t2243707580_marshaled_com ___m_Center_2;
	float ___m_AxisLength_3;
	int32_t ___m_UseDefaultValues_4;
};

...
struct  ClientSessionInfo_t1286  : public Object_t
{
	...
	ByteU5BU5D_t159* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t159* ___masterSecret_5;
};
struct ClientSessionInfo_t1286_StaticFields{

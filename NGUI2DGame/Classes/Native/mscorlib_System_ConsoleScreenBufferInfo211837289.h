...
{
	Coord_t151819767_marshaled_pinvoke ___Size_0;
	Coord_t151819767_marshaled_pinvoke ___CursorPosition_1;
	int16_t ___Attribute_2;
	SmallRect_t2523714067_marshaled_pinvoke ___Window_3;
	Coord_t151819767_marshaled_pinvoke ___MaxWindowSize_4;
};
// Native definition for marshalling of: System.ConsoleScreenBufferInfo
struct ConsoleScreenBufferInfo_t211837289_marshaled_com
{
	Coord_t151819767_marshaled_com ___Size_0;
	Coord_t151819767_marshaled_com ___CursorPosition_1;
	int16_t ___Attribute_2;
	SmallRect_t2523714067_marshaled_com ___Window_3;
	Coord_t151819767_marshaled_com ___MaxWindowSize_4;
};

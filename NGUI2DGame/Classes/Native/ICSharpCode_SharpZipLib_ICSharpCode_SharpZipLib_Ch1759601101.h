...
struct  Adler32_t1759601101  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_checksum_0() { return static_cast<int32_t>(offsetof(Adler32_t1759601101, ___checksum_0)); }

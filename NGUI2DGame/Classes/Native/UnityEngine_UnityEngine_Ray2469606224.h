...
{
	Vector3_t2243707580_marshaled_pinvoke ___m_Origin_0;
	Vector3_t2243707580_marshaled_pinvoke ___m_Direction_1;
};
// Native definition for marshalling of: UnityEngine.Ray
struct Ray_t2469606224_marshaled_com
{
	Vector3_t2243707580_marshaled_com ___m_Origin_0;
	Vector3_t2243707580_marshaled_com ___m_Direction_1;
};

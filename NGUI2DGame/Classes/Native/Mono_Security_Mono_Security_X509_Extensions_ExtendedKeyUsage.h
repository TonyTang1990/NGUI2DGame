...
struct  ExtendedKeyUsageExtension_t1263  : public X509Extension_t1257
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t913 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1263_StaticFields{
	...
	Dictionary_2_t60 * ___U3CU3Ef__switchU24map14_4;
};

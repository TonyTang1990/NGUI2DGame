...
struct ControllerColliderHit_t4070855101_marshaled_pinvoke
{
	CharacterController_t4094781467 * ___m_Controller_0;
	Collider_t3497673348 * ___m_Collider_1;
	Vector3_t2243707580_marshaled_pinvoke ___m_Point_2;
	Vector3_t2243707580_marshaled_pinvoke ___m_Normal_3;
	Vector3_t2243707580_marshaled_pinvoke ___m_MoveDirection_4;
	float ___m_MoveLength_5;
	int32_t ___m_Push_6;
};
// Native definition for marshalling of: UnityEngine.ControllerColliderHit
struct ControllerColliderHit_t4070855101_marshaled_com
{
	CharacterController_t4094781467 * ___m_Controller_0;
	Collider_t3497673348 * ___m_Collider_1;
	Vector3_t2243707580_marshaled_com ___m_Point_2;
	Vector3_t2243707580_marshaled_com ___m_Normal_3;
	Vector3_t2243707580_marshaled_com ___m_MoveDirection_4;
	float ___m_MoveLength_5;
	int32_t ___m_Push_6;
};

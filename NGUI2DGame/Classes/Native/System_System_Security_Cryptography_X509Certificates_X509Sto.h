...
struct  X509Store_t2117  : public Object_t
{
	...
	X509Certificate2Collection_t2109 * ___list_2;
	...
	X509Store_t1258 * ___store_4;
};
struct X509Store_t2117_StaticFields{
	...
	Dictionary_2_t60 * ___U3CU3Ef__switchU24map1B_5;
};

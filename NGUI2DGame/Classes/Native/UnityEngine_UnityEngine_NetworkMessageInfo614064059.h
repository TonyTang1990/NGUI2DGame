...
{
	double ___m_TimeStamp_0;
	NetworkPlayer_t1243528291_marshaled_pinvoke ___m_Sender_1;
	NetworkViewID_t3942988548_marshaled_pinvoke ___m_ViewID_2;
};
// Native definition for marshalling of: UnityEngine.NetworkMessageInfo
struct NetworkMessageInfo_t614064059_marshaled_com
{
	double ___m_TimeStamp_0;
	NetworkPlayer_t1243528291_marshaled_com ___m_Sender_1;
	NetworkViewID_t3942988548_marshaled_com ___m_ViewID_2;
};

...
#endif
// Native definition for marshalling of: UnityEngine.RaycastHit
struct RaycastHit_t87180320_marshaled_pinvoke
{
	Vector3_t2243707580_marshaled_pinvoke ___m_Point_0;
	Vector3_t2243707580_marshaled_pinvoke ___m_Normal_1;
	int32_t ___m_FaceID_2;
	float ___m_Distance_3;
	Vector2_t2243707579_marshaled_pinvoke ___m_UV_4;
	Collider_t3497673348 * ___m_Collider_5;
};
// Native definition for marshalling of: UnityEngine.RaycastHit
struct RaycastHit_t87180320_marshaled_com
{
	Vector3_t2243707580_marshaled_com ___m_Point_0;
	Vector3_t2243707580_marshaled_com ___m_Normal_1;
	int32_t ___m_FaceID_2;
	float ___m_Distance_3;
	Vector2_t2243707579_marshaled_com ___m_UV_4;
	Collider_t3497673348 * ___m_Collider_5;
};

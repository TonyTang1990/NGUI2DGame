...
{
	Vector3_t2243707580_marshaled_pinvoke ___m_Center_0;
	Vector3_t2243707580_marshaled_pinvoke ___m_Extents_1;
};
// Native definition for marshalling of: UnityEngine.Bounds
struct Bounds_t3033363703_marshaled_com
{
	Vector3_t2243707580_marshaled_com ___m_Center_0;
	Vector3_t2243707580_marshaled_com ___m_Extents_1;
};

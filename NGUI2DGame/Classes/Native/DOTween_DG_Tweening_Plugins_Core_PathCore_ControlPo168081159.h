...
{
	Vector3_t2243707580_marshaled_pinvoke ___a_0;
	Vector3_t2243707580_marshaled_pinvoke ___b_1;
};
// Native definition for marshalling of: DG.Tweening.Plugins.Core.PathCore.ControlPoint
struct ControlPoint_t168081159_marshaled_com
{
	Vector3_t2243707580_marshaled_com ___a_0;
	Vector3_t2243707580_marshaled_com ___b_1;
};

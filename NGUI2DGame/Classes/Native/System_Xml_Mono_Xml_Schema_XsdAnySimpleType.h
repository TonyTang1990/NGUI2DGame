...
// Mono.Xml.Schema.XsdAnySimpleType
struct  XsdAnySimpleType_t1500  : public XmlSchemaDatatype_t1051
{
};
struct XsdAnySimpleType_t1500_StaticFields{
	// Mono.Xml.Schema.XsdAnySimpleType Mono.Xml.Schema.XsdAnySimpleType::instance
	XsdAnySimpleType_t1500 * ___instance_55;
	// System.Char[] Mono.Xml.Schema.XsdAnySimpleType::whitespaceArray
	CharU5BU5D_t260* ___whitespaceArray_56;

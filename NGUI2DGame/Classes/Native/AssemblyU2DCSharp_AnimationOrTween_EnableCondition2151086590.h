...
struct  EnableCondition_t2151086590 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EnableCondition_t2151086590, ___value___1)); }

...
public:
	...
	inline int32_t get_m_ValueLow_1() const { return ___m_ValueLow_1; }
	inline int32_t* get_address_of_m_ValueLow_1() { return &___m_ValueLow_1; }
	inline void set_m_ValueLow_1(int32_t value)
	{

...
struct PathOptions_t2659884781_marshaled_pinvoke
{
	...
	Vector3_t2243707580_marshaled_pinvoke ___lookAtPosition_5;
	Transform_t3275118058 * ___lookAtTransform_6;
	float ___lookAhead_7;
	int32_t ___hasCustomForwardDirection_8;
	Quaternion_t4030073918_marshaled_pinvoke ___forward_9;
	int32_t ___useLocalPosition_10;
	Transform_t3275118058 * ___parent_11;
	Quaternion_t4030073918_marshaled_pinvoke ___startupRot_12;
	float ___startupZRot_13;
};
// Native definition for marshalling of: DG.Tweening.Plugins.Options.PathOptions
struct PathOptions_t2659884781_marshaled_com
{
	...
	int32_t ___lockRotationAxis_3;
	int32_t ___isClosedPath_4;
	Vector3_t2243707580_marshaled_com ___lookAtPosition_5;
	Transform_t3275118058 * ___lookAtTransform_6;
	float ___lookAhead_7;
	int32_t ___hasCustomForwardDirection_8;
	Quaternion_t4030073918_marshaled_com ___forward_9;
	int32_t ___useLocalPosition_10;
	Transform_t3275118058 * ___parent_11;
	Quaternion_t4030073918_marshaled_com ___startupRot_12;
	float ___startupZRot_13;
};
